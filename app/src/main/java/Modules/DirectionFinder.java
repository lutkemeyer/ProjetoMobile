...
public class DirectionFinder {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyD216ZoaQJEiYYGYBYS2ujSKKumY5744gQ";
    ...
    public void execute() throws UnsupportedEncodingException {
        ...
        String urlRequisicao = createUrl();
        Log.i("Script", urlRequisicao);
        new DownloadRawData().execute(urlRequisicao);
    }
    ...
    private void parseJSon(String data) throws JSONException {
        ...
        for (int i = 0; i < jsonRoutes.length(); i++) {
            ...
            rota.setLocalInicial( new LatLng(jsonStartLocation.getDouble("lat"), jsonStartLocation.getDouble("lng")) );
            rota.setLocalFinal( new LatLng(jsonEndLocation.getDouble("lat"), jsonEndLocation.getDouble("lng")) );
            rota.setPontos( decodePolyLine(overview_polylineJson.getString("points")) );

            rotas.add(rota);
        }
        listener.resultadoRequisicao(TipoRetornoDirectionsAPI.valueOf(jsonData.getString("status")));
        listener.onDirectionFinderSuccess(rotas);
    }
